...
```{r visualization, fig.width = 10, fig.height = 5, out.width = "100%", out.extra='style="border:none;"'}
...
```{r forecasts, fig.width = 10, fig.height = 5, out.width = "100%", out.extra='style="border:none;"'}
ggplot(dplyr::filter(r_enwiki, date >= "2016-10-01"),
       aes(x = date, y = pageviews)) +
  geom_line() +
